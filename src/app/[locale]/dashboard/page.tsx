...
import { TIER_COLORS, calculateUserTier, getUserTierProgress } from '@/lib/tiers'
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Completed Lends</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              <Badge className={TIER_COLORS[profile?.tier || 'bronze']}>
                {profile?.tier || 'Bronze'}
              </Badge>
            </div>
            <p className="text-xs text-muted-foreground">
                        ...
                        <div key={request.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-gray-600 truncate">
                              wants to borrow "{request.items.title}"
                            </p>
